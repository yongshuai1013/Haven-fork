...
object DatabaseModule {
    ...
    @Provides
    fun provideChatConversationDao(db: HavenDatabase): ChatConversationDao = db.chatConversationDao()

    @Provides
    fun provideChatMessageDao(db: HavenDatabase): ChatMessageDao = db.chatMessageDao()
}
